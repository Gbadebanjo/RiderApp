...
export default function FacialIdToggle({ navigation, route }) {
  ...
  const toggleFacialID = () => {
    // Navigate to the password screen before toggling
    navigation.navigate('SettingsPasswordScreen', { originScreen: 'FacialIdToggle' });
  };
  ...
  useEffect(() => {
    if (route.params?.success) {
      ...
      setIsModalVisible(true);  // Show modal on successful toggle
    }
